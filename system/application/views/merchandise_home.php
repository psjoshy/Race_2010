<div id="content-wrapper">
            ...
            <div class="main_content">
				<h2>Merchandise Collection Page </h2>
				<br />
...
<p>Remark</p>
<textarea cols="60" rows="8" name="merchandise_remarks" ><?= $row3->merchandise_remarks ?></textarea><br/>

<table width="100%">
<tr>
<? if($row3->merchandise_selfcollect =='' && $row3->merchandise_collectit == ''){ ?>
<td>
<input name="merchandise_selfcollect" type="radio" value="1"   checked="checked"    /> <label>Self Collect</label>
</td>
<td align="right">
<input name="merchandise_selfcollect" type="radio" value="0"  /> Collect on Behalf 
</td>
<?  } else {  
		if($row3->merchandise_selfcollect =='' &&  $row3->merchandise_collectit <> '' ){ ?>
		
		<td>
		<input name="merchandise_selfcollect" type="radio" value="1"     /> <label>Self Collect</label>
		</td>
		<td align="right">
		<input name="merchandise_selfcollect" type="radio" value="0"   checked="checked"   /> Collect on Behalf 
		</td>
		<?
		}else{  ?>
		<td>
...
<tr>
  ...
  <td align="right"><input type="hidden" name="merchandise_collectit" value="1" />
<input type="hidden" name="merchandise_date" value="<?= date("m-d-y h:m") ?>">
<input type="hidden" name="merchandise_created_by" value="<?= $this->session->userdata("name") ?>">
<input type="hidden" name="merchandise_counter" value="<?= $this->session->userdata("counter") ?>">
