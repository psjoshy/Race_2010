<div id="content-wrapper">
	...
	<h2>Collection Rate (15 mins) Report</h2>
	<form action="<?= $base ?>/index.php/admin/report_15" method="post"><span>
	...
	else
	{
		...
		<table border="1" style="position: relative; margin-top: 10px; margin-left: auto; margin-right: auto;">
			...
			<a href="<?= $base ?>/index.php/admin/report_export_15/<?= $curr_date ?>">Export To Excel</a>
	<?
	}
	?>
