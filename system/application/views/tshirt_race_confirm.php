<div id="content-wrapper">
	...
	<form method="post" action="<?= $base ?>/index.php/admin/confrim_racepack">
				<table>
			<tr>

				<td>Quantity</td>
				<td><input type="text" name="quantity" id="quantity" value="<?= $val=$row->quantity ;?>"  /></td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="hidden" name="type" value="shirts">
