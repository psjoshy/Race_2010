<div id="content-wrapper">
	...
	<form method="post" action="<?= $base ?>/index.php/admin/skorts_confrim_racepack">
				<table>
			<tr>
			...
			<tr>
				<td colspan="2">
					<input type="hidden" name="type" value="skorts">
					<input type="hidden" name="created_date" value="<?= date("Y-d-m") ?>">
